...
import { Add_Participate } from '../../../../utils/util_chat/Participate';
import {
  createConversation,
...
import { createListfriend } from '../../../../cache_datas/exportdata.ts/friend_cache';
const SearchItemUser: React.FC<{ item: itemuser; navigation: any }> = ({
  item,
  navigation,
}) => {
