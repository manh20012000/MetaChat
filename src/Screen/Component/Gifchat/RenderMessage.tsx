...
const MessageItem: React.FC<MessageProps> = ({
  ...
  const [sizeMessage, setSizeMessage] = useState<{ widthMessage: number, heightMessage: number }>({widthMessage: 0, heightMessage: 0})
...
const MAX_SWIPE_DISTANCE = width * 0.3; // Giảm khoảng cách tối đa
  ...
  return (
      ...
      <View
        style={{ marginBottom: 2, marginHorizontal: 10, position: 'relative' }}>
        <Day {...props} />
