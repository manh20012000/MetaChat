bạn hiểu nhầm ý mình rồi mình cần thực hiện hiện tách useApp thành 2 file là 1 file notifi và 1 file useApp nhưng notificonfige vẫn được gọi ở màn useApp nha . useApp viết ngắn gọn lại chỉ cần các còn hàm check quyền thôi nha import {useEffect} from 'react';
import messaging from '@react-native-firebase/messaging';
import notifee, {AndroidImportance, EventType} from '@notifee/react-native';
import RNCallKeep from 'react-native-callkeep';
import {Permission, PermissionsAndroid, Platform} from 'react-native';
import {navigationRef} from '../navigation/navigation';
import {userSchema} from '../cache_data/Schema/chat_convertstation_schema';
